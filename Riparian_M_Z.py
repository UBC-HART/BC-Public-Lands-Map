...
StreamNetworkFC = r'BCFWA_STREAM_NETWORKS_M_Z'
...
LinearNetworkFC = r'BCFWA_LINEAR_BOUNDARIES_M_Z'
...
riplineFC = "Riparian_lines_M_Z"
print("Running Merge...")
arcpy.management.Merge([linearOut,streamOut,coastOut], riplineFC)
print(riplineFC + " created")

rippolyFC = "Riparian_buffer_M_Z"

print("Running Pairwise Buffer on " + riplineFC + " ...")
...
print("Add and calculate Riparian field")
